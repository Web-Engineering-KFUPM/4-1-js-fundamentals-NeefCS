...
course = "ICS102";
console.log("The reassign course" + course);
...
const SCHOOL = "MyCollege";
// SCHOOL = "OtherCollege";   # since it is  constant you cannnot re assign it.
...
console.log (x-y); //5
console.log (x*y); //24
console.log (x/y); //2.6665
console.log (x%y); //2


// Task 3.2 — number vs string
// Display results of "2" + 3, 2 + "3", and 2 + 3. Add a short comment: why do the first two concatenate? Because when you add string is not arithmetic operation
// write code here
console.log ("2" + 3);   // "23"
console.log (2 + "3");   // "23"
console.log (2 + 3);     // 5
